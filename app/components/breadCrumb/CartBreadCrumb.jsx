...
import banner2 from "@/public/assets/banner/cart-page.jpg"
...
export default function CartBreadcrumb({ title }) {
  return (
    <div style={bgStyleBanner2} className="h-[400px] w-full -mt-20 ">
      <div className="container ">
         <div className="flex flex-col justify-center items-center pt-40">
          ...
          <h1 className="text-[30px] xl:text-[64px] font-bold text-white "> CART</h1>
         </div>
      </div> 
    </div>
  )
