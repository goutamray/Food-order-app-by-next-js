...
import banner2 from "@/public/assets/banner/menu-page.jpg"
...
export default function Menu2Breadcrumb({ title }) {
  return (
    <div style={bgStyleBanner2} className="h-[400px] w-full -mt-20 ">
     <div className="container ">
       <div className="flex flex-col justify-center items-center pt-40">
        ...
        <h1 className="text-[30px] xl:text-[64px] capitalize font-bold text-white ">{title }  </h1>
       </div>
    </div> 
  </div>
  )
