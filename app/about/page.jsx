    ...
    <div>
       ...
       <div className="py-20">
        <div className="container flex gap-4 ">
            <div className="w-[50%]">
               <h2 className="text-[50px] font-semibold text-[#642F21] tracking-tighter"> DISCOVER THE NEW TASTE OF THE BURGER </h2>
               <p className="text-[18px] text-[#757575] font-thin w-[600px]"> Porta semper lacus cursus, feugiat primis ultrice and ligula risus auctor an tempus feugiat dolor lacinia cubilia a curae integer orci congue and metus mollislorem primis </p> 
               <div>
            ...
            <div  className="w-[50%]">
              <div>
                <Image src={img2} alt="photo" className="h-[680px] rounded-sm overflow-hidden" /> 
               </div>
       ...
       <div className="py-10 px-4">
         <div className="">
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
                <div className="flex flex-col justify-center items-center h-[370px] w-[350px] rounded-md" style={bgStyleBanner} >
                ...
                {/* column 2  */}
                <div className="flex  flex-col col-span-2 justify-center items-center h-[370px] w-[700px] rounded-md" style={bgStyleBanner2} >
                     <h1 className="text-white text-[42px] font-bold mt-10 "  > ORDER NOW </h1>
                     <p className="text-[19px] text-white font-normal "> Want to join our team? </p> 
                     <button className="my-btn uppercase bg-[#E3000E] font-medium text-md px-4 py-[10px] rounded-sm text-white w-[160px] overflow-hidden "> learn more </button>
                </div>
                {/* column 3 */}
                <div className="flex flex-col justify-center items-center h-[370px] w-[350px] rounded-md" style={bgStyleBanner3} >
                     <h1 className="text-white text-[42px] font-bold mt-10 "  > CAREERS </h1>
                     <p className="text-[19px] text-white font-normal "> Want to join our team? </p> 
                     <button className="my-btn uppercase bg-[#E3000E] font-medium text-md px-4 py-[10px] rounded-sm text-white w-[160px] overflow-hidden "> learn more </button>
                </div>
